...
pub fn load() Config {
    return .{
        ...
        .stream_names_csv = "proxy.events,wireless.audit",
        .batch_size = parseBatchSize(envOrDefault("SYNC_BATCH_SIZE", "100")),
        .scan_subject = "sync.scan.request",
        .load_subject = "sync.oracle.load",
        .result_subject = "sync.oracle.result",
        ...
        .audit_stream_name = "AUDIT_STREAM",
        .result_stream_name = "ORACLE_RESULT_STREAM",
