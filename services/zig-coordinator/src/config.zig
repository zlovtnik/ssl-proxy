...
pub const Config = struct {
    ...
    scan_topic: []const u8,
    load_topic: []const u8,
    result_topic: []const u8,
    database_url: []const u8,
    sync_redpanda_url: []const u8,
    redpanda_topic_manifest_file: []const u8,
    ...
    wireless_backlog_list_reply_topic: []const u8,
    wireless_backlog_prune_reply_topic: []const u8,
    wireless_mac_lookup_reply_topic: []const u8,
    wireless_networks_authorized_reply_topic: []const u8,
    ...
    redpanda_publish_timeout_ms: u32,
...
pub fn load() Config {
    return .{
        ...
        .result_topic = envOrDefault("SYNC_RESULT_TOPIC", "sync.oracle.result"),
        ...
        .wireless_backlog_list_reply_topic = envOrDefault("WIRELESS_BACKLOG_LIST_REPLY_TOPIC", "wireless.backlog.list.reply"),
        .wireless_backlog_prune_reply_topic = envOrDefault("WIRELESS_BACKLOG_PRUNE_REPLY_TOPIC", "wireless.backlog.prune.reply"),
        .wireless_mac_lookup_reply_topic = envOrDefault("WIRELESS_MAC_LOOKUP_REPLY_TOPIC", "wireless.mac.lookup.reply"),
        .wireless_networks_authorized_reply_topic = envOrDefault("WIRELESS_NETWORKS_AUTHORIZED_REPLY_TOPIC", "wireless.networks.authorized.reply"),
        ...
        .ingest_batch_size = parsePositiveU32(envOrDefault("SYNC_INGEST_BATCH_SIZE", "1000"), 1000),
        .dispatch_batch_size = parsePositiveU32(envOrDefault("SYNC_DISPATCH_BATCH_SIZE", "50"), 50),
        .idle_sleep_ms = parsePositiveU32(envOrDefault("SYNC_IDLE_SLEEP_MS", "250"), 250),
        .idle_sleep_backoff_ms = parsePositiveU32(envOrDefault("SYNC_IDLE_SLEEP_BACKOFF_MS", "1000"), 1000),
    };
}
