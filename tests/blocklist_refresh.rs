...
mod tests {
    ...
    /// Constructs a SharedState initialized with a system DNS resolver, two broadcast channels, an HTTP client, and the default configuration.
    ///
    /// # Examples
    ///
    /// ```
    ...
    /// // use `state` for tests or local integration scenarios
    /// # }
    /// ```
