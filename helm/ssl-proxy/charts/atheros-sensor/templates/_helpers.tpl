...
{{- define "ssl-proxy.atherosSensor.name" -}}
{{- default "ssl-proxy" .Values.global.nameOverride | trunc 63 | trimSuffix "-" }}
{{- end }}

{{- define "ssl-proxy.atherosSensor.fullname" -}}
...
{{- define "ssl-proxy.atherosSensor.selectorLabels" -}}
app.kubernetes.io/name: {{ include "ssl-proxy.atherosSensor.name" . }}
...
{{- define "ssl-proxy.atherosSensor.image" -}}
...
{{- define "ssl-proxy.atherosSensor.serviceAccountName" -}}
{{- if .Values.global.serviceAccount.create }}
{{- default (include "ssl-proxy.atherosSensor.fullname" .) .Values.global.serviceAccount.name }}
{{- else }}
